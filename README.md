...
- **[Assignment 2](Assignment2/README.md)** — (bonus) LoRA fine-tune of a Thai-first open model
  (Typhoon) to match the A1 commercial baseline on the **same held-out eval set**, enabling self-hosted
  inference. A2 reuses A1's eval harness and held-out eval set as the single source of truth.
